...
// Accent do projeto (verde-banana Mario Party 1) para controles neutros pressionados.
...
/**
 * Gamepad virtual do port Android do Mario Party 1: Recompiled — v2 "dark glass".
 *
 ...
 * verde Mario Party 1). O HUD entra/sai com fade+deslize e aparece sozinho quando o
...
class VirtualPadView @JvmOverloads constructor(
    ...
    companion object {
        ...
        // usado no Mario Party 1; os ids são mantidos para casar com o enum nativo.
